        ...
        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && (KeyDown != null || KeyUp != null || KeyPress != null))
            {
                ...
                if (this.started)
                {
                    ...
                    if (MyKeyboardHookStruct.vkCode == 91)  // 截获左win(开始菜单键) 
                    {
                        return 1;
                    }
                    if (MyKeyboardHookStruct.vkCode == 92)// 截获右win 
                    {
                        return 1;
                    }

                    if (MyKeyboardHookStruct.vkCode == (int)Keys.Escape && (int)Control.ModifierKeys == (int)Keys.Control) //截获Ctrl+Esc 
                    {
                        return 1;
                    }

                    if (MyKeyboardHookStruct.vkCode == (int)Keys.F4 && (int)Control.ModifierKeys == (int)Keys.Alt) //截获Alt+F4
                    {
                        return 1;
                    }
                    if (MyKeyboardHookStruct.vkCode == (int)Keys.Tab && (int)Control.ModifierKeys == (int)Keys.Alt) //截获Alt+Tab
                    {
                        return 1;
                    }
                    if (MyKeyboardHookStruct.vkCode == (int)Keys.F1 || MyKeyboardHookStruct.vkCode == (int)Keys.F2 || MyKeyboardHookStruct.vkCode == (int)Keys.F3 || MyKeyboardHookStruct.vkCode == (int)Keys.F4 || MyKeyboardHookStruct.vkCode == (int)Keys.F5 || MyKeyboardHookStruct.vkCode == (int)Keys.F6 || MyKeyboardHookStruct.vkCode == (int)Keys.F7 || MyKeyboardHookStruct.vkCode == (int)Keys.F8 || MyKeyboardHookStruct.vkCode == (int)Keys.F9 || MyKeyboardHookStruct.vkCode == (int)Keys.F10 || MyKeyboardHookStruct.vkCode == (int)Keys.F11 || MyKeyboardHookStruct.vkCode == (int)Keys.F12) //截获Ctrl+Esc 
                    {
                        return 1;
                    }
                }
